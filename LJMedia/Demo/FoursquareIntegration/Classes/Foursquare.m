...
- (void) login
{
	...
	if(rootController != nil)
	{
		...
		FoursquareConnectController *connectController = [[FoursquareConnectController alloc] initWithNibName:@"FoursquareConnectView" bundle:[NSBundle mainBundle]];
...
- (void) restoreSession
{
	self.oauthToken = [[[OAToken alloc] initWithUserDefaultsUsingServiceProviderName:OAUTHTOKEN_PROVIDER  																			  prefix:OAUTHTOKEN_PREFIX] autorelease];
}
